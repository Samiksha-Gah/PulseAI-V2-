        ...
        >
          ...
          <div className="hidden md:block">
            ...
            <div className="space-y-4">
              ...
              <div className="pt-4 mt-4 border-t border-white/20">
                ...
                {/* Summarize button - full width on new row */}
                <div className="w-full mt-2">
                  <button
                    ...
                    className="w-full px-3 py-2.5 bg-indigo-600/90 text-white rounded-lg hover:bg-indigo-500 transition-colors text-xs font-semibold flex items-center justify-center gap-2"
                  >
                    <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="md:hidden">
            ...
            <div className="pt-1.5 border-t border-white/20 space-y-1.5">
              ...
              {/* Third row: Summarize button - full width */}
              <div className="w-full">
                <button
                  ...
                  disabled={!onSummarizeSession}
                  className="w-full px-2 py-1.5 bg-indigo-600/90 text-white rounded-lg hover:bg-indigo-500 transition-colors text-[10px] font-semibold flex items-center justify-center gap-1.5"
                >
                  <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                  </svg>
